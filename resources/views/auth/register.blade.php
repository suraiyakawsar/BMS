    ...
    <div class="flex flex-row pt-16">
        <div class="w-6/12">
            ...
            <section class="px-28 flex flex-col break-words bg-white">
                <header class="font-semibold text-center text-gray-700 text-3xl mt-4 p-5 sm:py-6 sm:px-8 sm:rounded-t-md">
                    {{ __('Register') }}
                </header>

                <form class="mb-8 w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST" action="{{ route('register') }}">
                    @csrf
